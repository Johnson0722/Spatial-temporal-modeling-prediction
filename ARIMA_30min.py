...
def loadDataSet():
    ...
    ##miss data operation
    MyTrafficFrame =  MyTrafficFrame.dropna(axis = 1,thresh = 935)            #[1427 rows * 19 columns]
...
rng = pd.date_range('6/1/2014 00:00',periods = 1427,freq = '30Min')
traffic = normalization(traffic)
traffic_train = traffic[:1000]
traffic_test = traffic[1000:]                                                #type(traffic) = <class 'pandas.core.series.Series'>   
...
predict_ts_test = result_arma.predict('6/21/2014 20:00:00','6/30/2014 17:00:00',dynamic = True)
...
traffic_test.to_csv('/home/johnson/tensorflow/pic/30min/result_30min/ARIMA_test_result')
predict_ts_test.to_csv('/home/johnson/tensorflow/pic/30min/result_30min/ARIMA_predict_result')
print metrics.mean_squared_error(traffic_test,predict_ts_test)              ##MSE = 0.0153648
print metrics.mean_absolute_error(traffic_test,predict_ts_test)             ##MAE = 0.0831948
